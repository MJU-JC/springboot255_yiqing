...
public class DakaEntity<T> implements Serializable {
     ...
     * 打卡地点
     */
    @TableField(value = "didian_address")

    private String didianAddress;
	 ...
	 * 设置：打卡地点
	 */
    public String getDidianAddress() {
        return didianAddress;
    }
    /**
	 * 获取：打卡地点
	 */

    public void setDidianAddress(String didianAddress) {
        this.didianAddress = didianAddress;
    }
    /**
	 * 设置：打卡备注
	 */
