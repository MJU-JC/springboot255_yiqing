...
public class ShequguanliyuanEntity<T> implements Serializable {
     ...
     * 社区管理员身份证号
     */
    @TableField(value = "shequguanliyuan_id_number")

    private String shequguanliyuanIdNumber;
	 ...
	 * 设置：社区管理员身份证号
	 */
    public String getShequguanliyuanIdNumber() {
        return shequguanliyuanIdNumber;
    }
    /**
	 * 获取：社区管理员身份证号
	 */

    public void setShequguanliyuanIdNumber(String shequguanliyuanIdNumber) {
        this.shequguanliyuanIdNumber = shequguanliyuanIdNumber;
    }
    /**
	 * 设置：社区管理员头像
	 */
    ...
    public String toString() {
        return "Shequguanliyuan{" +
            ...
            ", shequguanliyuanIdNumber=" + shequguanliyuanIdNumber +
