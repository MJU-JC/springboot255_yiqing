    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="打卡地点" prop="didianAddress">
                       <el-input v-model="ruleForm.didianAddress"
                                 placeholder="打卡地点" clearable  :readonly="ro.didianAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="打卡地点" prop="didianAddress">
                           <el-input v-model="ruleForm.didianAddress"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.dakaContent"  label="打卡备注" prop="dakaContent">
