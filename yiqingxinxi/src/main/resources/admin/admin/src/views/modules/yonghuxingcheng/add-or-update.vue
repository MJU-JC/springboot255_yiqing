<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='diqu'">
                    <el-form-item class="select" v-if="type!='info'"  label="地区" prop="diquId">
                        <el-select v-model="ruleForm.diquId" :disabled="ro.diquId" filterable placeholder="请选择地区" @change="diquChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='diqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="地区编号" prop="diquUuidNumber">
                        <el-input v-model="diquForm.diquUuidNumber"
                                  placeholder="地区编号" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='diqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="地区名称" prop="diquName">
                        <el-input v-model="diquForm.diquName"
                                  placeholder="地区名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='diqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="地区位置" prop="diquAddress">
                        <el-input v-model="diquForm.diquAddress"
                                  placeholder="地区位置" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='diqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="地区风险等级" prop="fengxianValue">
                        <el-input v-model="diquForm.fengxianValue"
                                  placeholder="地区风险等级" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <input id="diquId" name="diquId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="去的时间" prop="quTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.quTime"
                                type="datetime"
                                placeholder="去的时间"
                                :disabled="ro.quTime">
                        </el-date-picker>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.quTime" label="去的时间" prop="quTime">
                            <span v-html="ruleForm.quTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="回的时间" prop="huiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.huiTime"
                                type="datetime"
                                placeholder="回的时间"
                                :disabled="ro.huiTime">
                        </el-date-picker>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.huiTime" label="回的时间" prop="huiTime">
                            <span v-html="ruleForm.huiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yuanyouContent"  label="去的缘由" prop="yuanyouContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yuanyouContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yuanyouContent" label="去的缘由" prop="yuanyouContent">
                            <span v-html="ruleForm.yuanyouContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   huiTime: [
                              { required: true, message: '回的时间不能为空', trigger: 'blur' },
                          ],
                   yuanyouContent: [
                              { required: true, message: '去的缘由不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `yonghuxingcheng/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.diquChange(data.data.diquId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yonghuxingcheng/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yonghuxingchengCrossAddOrUpdateFlag = false;
                                        this.parent.search();
