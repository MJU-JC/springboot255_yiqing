<template>
    <div style="backgroundImage: url('/yiqingxinxi/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">疫情信息管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="社区管理员姓名" class="input" v-if="tableName=='shequguanliyuan'">
                            <el-input v-model="ruleForm.shequguanliyuanName" autocomplete="off" placeholder="社区管理员姓名"  />
                        </el-form-item>
                        <el-form-item label="社区管理员手机号" class="input" v-if="tableName=='shequguanliyuan'">
                            <el-input v-model="ruleForm.shequguanliyuanPhone" autocomplete="off" placeholder="社区管理员手机号"  />
                        </el-form-item>
                        <el-form-item label="社区管理员身份证号" class="input" v-if="tableName=='shequguanliyuan'">
                            <el-input v-model="ruleForm.shequguanliyuanIdNumber" autocomplete="off" placeholder="社区管理员身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='shequguanliyuan'">
                            <el-input v-model="ruleForm.shequguanliyuanEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.shequguanliyuanName)&& 'shequguanliyuan'==this.tableName){
                                this.$message.error('社区管理员姓名不能为空');
                                return
                            }
                             if('shequguanliyuan' == this.tableName && this.ruleForm.shequguanliyuanPhone&&(!this.$validate.isMobile(this.ruleForm.shequguanliyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.shequguanliyuanIdNumber)&& 'shequguanliyuan'==this.tableName){
                                this.$message.error('社区管理员身份证号不能为空');
                                return
                            }
                            if('shequguanliyuan' == this.tableName && this.ruleForm.shequguanliyuanEmail&&(!this.$validate.isEmail(this.ruleForm.shequguanliyuanEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
